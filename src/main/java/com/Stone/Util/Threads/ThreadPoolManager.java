...
public class ThreadPoolManager
{
    ...
    private static final int SCHEDULED_THREAD_POOL_SIZE=NCPUS * 4;
    private static final int EXECUTOR_THREAD_POOL_SIZE=NCPUS * 2;
    private static final boolean ENABLE_RUNNABLE_STATS=false;
    ...
    {
        _scheduledExecutor = new ScheduledThreadPoolExecutor(SCHEDULED_THREAD_POOL_SIZE, new PriorityThreadFactory("ScheduledThreadPool", Thread.NORM_PRIORITY), new LoggingRejectedExecutionHandler());
        _executor = new ThreadPoolExecutor(EXECUTOR_THREAD_POOL_SIZE, Integer.MAX_VALUE, 5L, TimeUnit.SECONDS, new LinkedBlockingQueue<Runnable>(), new PriorityThreadFactory("ThreadPoolExecutor", Thread.NORM_PRIORITY), new LoggingRejectedExecutionHandler());
